...
def RunExp(args, dataset, data, Net, percls_trn, val_lb):
    ...
    for Nbit in range(9):
        ...
        model_quantized.lin1.weight.data=NonUnif_Quantization(model_quantized.lin1.weight.data,Nbit)
        model_quantized.lin1.bias.data=NonUnif_Quantization(model_quantized.lin1.bias.data,Nbit)
        model_quantized.lin2.weight=NonUnif_Quantization(model_quantized.lin2.weight,Nbit)
        model_quantized.lin2.bias.data=NonUnif_Quantization(model_quantized.lin2.bias.data,Nbit)
