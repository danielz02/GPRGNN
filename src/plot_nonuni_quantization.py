...
data = np.load("quan_non_uni.npz", allow_pickle=True)
...
plt.legend(ncol=3, loc="lower right")
plt.tight_layout()
plt.savefig('figures/nonuni_quan_accuracy.pdf', format='pdf')
plt.show()
...
plt.legend(ncol=3, loc="upper right")
plt.tight_layout()
plt.savefig('figures/nonuni_quan_mse_weight.pdf', format='pdf')
plt.show()
...
plt.legend(ncol=3, loc="upper right")
plt.tight_layout()
plt.savefig('figures/nonuni_quan_mse_bias.pdf', format='pdf')
plt.show()